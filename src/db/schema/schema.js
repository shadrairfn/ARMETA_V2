...
export const reviewsForum = pgTable("reviews_forum", {
	...
	id_subject: uuid("id_subject")
		.references(() => subjects.id_subject, { onDelete: "cascade" })
		.notNull(),
...
export const likeForums = pgTable("like_forums", {
	...
	id_user: uuid("id_user")
		.references(() => users.id_user, { onDelete: "cascade" })
		.notNull(),
	id_forum: uuid("id_forum")
		.references(() => reviewsForum.id_forum, { onDelete: "cascade" })
		.notNull(),
});
...
export const bookmarkForumsRelations = relations(bookmarkForums, ({ one }) => ({
	...
	forum: one(reviewsForum, {
		fields: [bookmarkForums.id_forum],
		references: [reviewsForum.id_forum],
	}),
}));
