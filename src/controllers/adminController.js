...
import { lecturers, reports, reviews, reviewsForum, users } from "../db/schema/schema.js";
...
// --- Reports ---
const getAllReports = asyncHandler(async (_req, res) => {
